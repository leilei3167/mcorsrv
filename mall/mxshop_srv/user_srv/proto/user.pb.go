...
type PageInfo struct {
	...
	PSize uint32 `protobuf:"varint,2,opt,name=pSize,proto3" json:"pSize,omitempty"` //每一页的大小
}
...
type UserListResponse struct {
	...
	Data  []*UserInfoResponse `protobuf:"bytes,2,rep,name=data,proto3" json:"data,omitempty"`    //[]UserInfoResponse
}
...
func (x *ChecResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*ChecResponse) ProtoMessage() {}

func (x *ChecResponse) ProtoReflect() protoreflect.Message {
	mi := &file_user_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use ChecResponse.ProtoReflect.Descriptor instead.
func (*ChecResponse) Descriptor() ([]byte, []int) {
	return file_user_proto_rawDescGZIP(), []int{8}
}

func (x *ChecResponse) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_user_proto_rawDesc = []byte{
	...
	0x64, 0x61, 0x79, 0x22, 0x5d, 0x0a, 0x11, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73,
	0x77, 0x6f, 0x72, 0x64, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x61, 0x73, 0x73,
	...
	0x72, 0x64, 0x22, 0x28, 0x0a, 0x0c, 0x43, 0x68, 0x65, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
	...
	0x32, 0x0a, 0x0d, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x57, 0x6f, 0x72, 0x64,
	0x12, 0x12, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x6b, 0x50, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64,
	0x49, 0x6e, 0x66, 0x6f, 0x1a, 0x0d, 0x2e, 0x43, 0x68, 0x65, 0x63, 0x52, 0x65, 0x73, 0x70, 0x6f,
...
var file_user_proto_goTypes = []interface{}{
	...
	(*ChecResponse)(nil),      // 8: ChecResponse
...
var file_user_proto_depIdxs = []int32{
	...
	8, // 12: User.CheckPassWord:output_type -> ChecResponse
