...
type UserClient interface {
	...
	CheckPassWord(ctx context.Context, in *CheckPasswordInfo, opts ...grpc.CallOption) (*ChecResponse, error)
}
...
func (c *userClient) CheckPassWord(ctx context.Context, in *CheckPasswordInfo, opts ...grpc.CallOption) (*ChecResponse, error) {
	out := new(ChecResponse)
...
type UserServer interface {
	...
	CheckPassWord(context.Context, *CheckPasswordInfo) (*ChecResponse, error)
...
func (UnimplementedUserServer) CheckPassWord(context.Context, *CheckPasswordInfo) (*ChecResponse, error) {
